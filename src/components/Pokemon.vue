<template>
  <Page>
    ...
    <StackLayout backgroundColor="#FFF">
      <FlexboxLayout flexDirection="column" class="PokemonContainer">
        ...
        <Label text="Descrição" class="description" />
        <Label
...
<script>
export default {
  props: ["id", "name", "image", "description", "types"],
